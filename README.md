...
- [ ] SYMBOL_DESCRIPTION
- [x] SYMBOL_DIGITS
- [x] SYMBOL_EXPIRATION_MODE
- [x] SYMBOL_EXPIRATION_TIME
- [x] SYMBOL_FILLING_MODE
- [x] SYMBOL_LAST
- [x] SYMBOL_LASTHIGH
- [x] SYMBOL_LASTLOW
- [ ] SYMBOL_LEFTPRICE
